            ...
            <div className="md:w-3/4">
              <div className="space-y-4 md:space-y-6 text-base md:text-lg leading-relaxed text-muted-foreground">
                <p>
                  ...
                  analytics, and I'm drawn to product management because it sits
                  at the intersection of problem-solving, user understanding,
                  and strategic decision-making.
                </p>
                <p>
                  Across my engineering work, I've been most energized by
                  figuring out what to build, why it matters, and how it should
                  work. I like breaking down complex challenges, uncovering user
                  needs, and shaping clear product direction supported by data
                  and experimentation. Whether I'm building AI tools, full-stack
                  applications, or analytics systems, I approach each project
                  with the mindset of creating value, not just writing code.
                </p>
                <p>
                ...
                <p>
                  Outside of work, I focus on fitness, personal development, and
                  building meaningful relationships. I'm driven by growth,
                  consistency, and the belief that every project is an
                  opportunity to learn and create something better than before.
                </p>
              </div>
            </div>
          </div>
